...
<table width="100%" height="95%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <form action="caller!smslist.action" name="snumForm" method="post">
                    ...
                    <td align="center" colspan="4">
                        <table width="100%" cellpadd
                            ...
                            <tr height="20">
                                ...
                                <th width="8%" class="left_bt2">linkid</th>
                                <th width="10%" class="left_bt2">上行时间</th>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${bean.type=='1'}">
                                                扣量
                                                <font color="blue">
                                                    &nbsp;<a href="caller!bufasms.action?pageView.caller=${bean.mobile}&pageView.id=${bean.id}">补发</a>
                                                </font>
                                            </c:when>
                                            <c:otherwise>
                                ...
                                <tr class='t2'>
                                    ...
                                    <td>同步[${bean.sendnum}]次
                                        <c:if test="${bean.sendnum >= 3}">
                                            <font color="blue">
                                                &nbsp;<a href="caller!syncsms.action?pageView.caller=${bean.mobile}&pageView.id=${bean.id}">重新同步</a>
                                            </font>
                                        </c:if>
                                    </td>
                                </tr>
