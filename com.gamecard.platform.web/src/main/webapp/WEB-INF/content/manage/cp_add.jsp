    ...
    <table width="100%" height="95%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td height="200" valign="top" bgcolor="#F7F8F9">
                <form id="cpForm" name="cpForm" method="post" action="cp!doAdd.action" onsubmit="return check();">
                    <input type="hidden" name="pageView.id" value="${pageView.id}">
                    <input type="hidden" name="pageView.role" value="${pageView.role}">
                    <input type="hidden" name="pageView.parentId" value="${pageView.parentId}">
                            ...
                            <td align="center" colspan="4">
                                <table width="60%" cellpadd
                                    ...
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="name" name="pageView.name" value="${pageView.name}" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="passwd" name="pageView.passwd" value="${pageView.passwd}" />(单位：分)
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="showname" name="pageView.showname" value="${pageView.showname}" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="syncurl" name="pageView.syncurl" value="${pageView.syncurl}" />(默认等同于主帐号)
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <select name="pageView.status">
                                                    <option value="1" <c:if test="${pageView.status == 1}">selected</c:if>>启用</option>
                                                    <option value="0" <c:if test="${pageView.status == 0}">selected</c:if>>停用</option>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
