    ...
    <table width="100%" height="95%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td height="200" valign="top" bgcolor="#F7F8F9">
                <form id="spInfoForm" name="spInfoForm" method="post" action="cpnum!doPradd.action" onsubmit="return check();">
                            ...
                            <td align="center" colspan="4">
                                <table width="60%" cellpadd
                                    ...
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="spnum" name="pageView.called" value="${pageView.called}" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <s:select theme="simple" id="province" name="pageView.province" list="list2" listKey="name"
                                                          listValue="province">
                                                </s:select>
                                            </div>
                                        </td>
                                    ...
                                    <tr class='t2' height="20">
                                        ...
                                        <td>
                                            <div align="left">
                                                <input size="60" id="deductRate" name="pageView.deductRate" value="${pageView.deductRate}" />
                                            </div>
                                        </td>
                                    </tr>
