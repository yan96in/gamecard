                ...
                <tr>
                    <td align="center" colspan="4">
                        <table width="100%" cellpadd
                            ...
                            <tr height="20">
                                <th width="8%" class="left_bt2">号码</th>
                                <th width="8%" class="left_bt2">放量信息</th>
                            </tr>
                            <s:iterator value="list3" id="bean">
                                <tr class='t2'>
                                    <td>${bean.called}</td>
                                    <td align="left">${bean.blackinfo}</td>
                                </tr>
                            </s:iterator>
                        </table>
                    </td>
                ...
                <tr>
                    <td align="center" colspan="4">
                        <table width="100%" cellpadd
                            ...
                            <tr height="20">
                                <th width="8%" class="left_bt2">号码</th>
                                <th width="8%" class="left_bt2">省份</th>
                                <th width="8%" class="left_bt2">日上限</th>
                                <th width="8%" class="left_bt2">月上限</th>
                            </tr>
