...
<table width="100%" height="95%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <form action="list.action" name="snumForm" method="post">
                ...
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table3">
                    <tr>
                        ...
                        <td class="left_txt" height="31" width="15%">
                            被叫号码：
                            <s:select list="{'16836580','16836556','16836570'}"
                                      name="pageView.called" headerKey="ALL" headerValue="ALL" />
                        </td>
                        <td class="left_txt" height="31" width="15%">
                            数据类型：
                            <s:select list="#{0:'被叫号码',1:'分省',2:'点卡'}"
                ...
                <tr>
                    <td align="center" colspan="4">
                        <table width="100%" cellpadd
                            ...
                            <tr height="20">
                                <th width="8%" class="left_bt2">分组类型</th>
